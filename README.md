...
| `ghcr.io/felddy/foundryvtt:14.361` | The most recent image matching the major and minor version numbers. |
| `ghcr.io/felddy/foundryvtt:14.361.0` | An exact image version. |
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `14.361` |
...
```console
docker build \
  --tag ghcr.io/felddy/foundryvtt:14.361.0 \
