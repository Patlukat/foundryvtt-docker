...
| `felddy/foundryvtt:14.357` | The most recent image matching the major and minor version numbers. |
| `felddy/foundryvtt:14.357.0` | An exact image version. |
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `14.357` |
...
```console
docker build \
  --tag felddy/foundryvtt:14.357.0 \
