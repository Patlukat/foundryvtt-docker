...
|`felddy/foundryvtt:13.340`| The most recent image matching the major and minor version numbers. |
|`felddy/foundryvtt:13.340.0`| An exact image version. |
...
```console
docker build \
  --tag felddy/foundryvtt:13.340.0 \
