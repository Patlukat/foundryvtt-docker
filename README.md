...
|`felddy/foundryvtt:13.344`| The most recent image matching the major and minor version numbers. |
|`felddy/foundryvtt:13.344.0`| An exact image version. |
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `13.344` |
...
```console
docker build \
  --tag felddy/foundryvtt:13.344.0 \
