...
|`felddy/foundryvtt:13.348`| The most recent image matching the major and minor version numbers. |
|`felddy/foundryvtt:13.348.0`| An exact image version. |
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `13.348` |
...
```console
docker build \
  --tag felddy/foundryvtt:13.348.0 \
